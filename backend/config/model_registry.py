...
REGISTRY: dict[str, dict] = {
    ...
    "mistral": {
        ...
        "description":              "Zero-cost Mistral 7B via OpenRouter. Ideal for experimentation and simple queries.",
        "provider":                 "OpenRouter",
        "provider_type":            "openrouter",
        "api_model":                "mistralai/mistral-7b-instruct:free",
        "tier":                     "free",
        "cost_level":               "Very Low",
        "latency_level":            "Fast",
        "quality_level":            "Basic",
    ...
    "llama3": {
        ...
        "description":              "Meta Llama 3.1 8B via OpenRouter free tier. Zero cost, real AI responses.",
        "provider":                 "OpenRouter",
        "provider_type":            "openrouter",
        ...
        "daily_limit":              500,
        "fallback_chain":           [],
        "recommended_for":          ["basic queries", "drafts", "cost-free experimentation"],
    ...
    "gemini": {
        ...
        "description":              "Google Gemini Flash 1.5 8B via OpenRouter free tier. Fast and capable.",
        "provider":                 "OpenRouter",
        "provider_type":            "openrouter",
        "api_model":                "google/gemini-flash-1.5-8b:free",
        "tier":                     "free",
        "cost_level":               "Very Low",
        "latency_level":            "Fast",
        "quality_level":            "Good",
