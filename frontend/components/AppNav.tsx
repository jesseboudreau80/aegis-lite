...
const NAV = [
  ...
  { href: '/agents',    label: 'Agents',    icon: 'M9 3H5a2 2 0 00-2 2v4m6-6h10a2 2 0 012 2v4M9 3v18m0 0h10a2 2 0 002-2V9M9 21H5a2 2 0 01-2-2V9m0 0h18' },
...
const ADMIN_NAV = [
  ...
  { href: '/governance/audit',    label: 'Audit',      icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4' },
  { href: '/governance/policies', label: 'Policies',   icon: 'M9 12l2 2 4-4m-6 8a9 9 0 110-18 9 9 0 010 18zm0-14v4m0 4h.01' },
  { href: '/governance/systems',  label: 'AI Registry',icon: 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10' },
]
...
function NavItem({ href, label, icon, active, currentPage, compact }: {
  href: string; label: string; icon: string
  active: boolean; currentPage?: string; compact: boolean
}) {
  if (active && currentPage) {
    return (
      <span className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-gray-800 text-white text-xs font-medium">
  ...
  return (
    <Link
      ...
      className={`flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs transition-colors ${
        active ? 'bg-gray-800 text-white font-medium' : 'text-gray-500 hover:text-gray-200 hover:bg-gray-800/60'
      }`}
    >
      <svg className="w-3.5 h-3.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d={icon} />
